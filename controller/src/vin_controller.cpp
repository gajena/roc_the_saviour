...
{
    ros::init(argc, argv, "vin_controller");
    ros::NodeHandle nh;
    ...
    while ( ros::ok() )
    {
    	...
    	nh.getParam("/vin_controller/k_p", k_p);
		nh.getParam("/vin_controller/k_d", k_d);
    	nh.getParam("/vin_controller/k_i", k_i);
    	nh.getParam("/vin_controller/offset", offset);
